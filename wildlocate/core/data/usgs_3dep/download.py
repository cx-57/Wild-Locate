...
def main():
    ...
    parser.add_argument("--output", default="data/raw/usgs_3dep/elevation_3dep.tif")
    parser.add_argument("--width", type=int, default=2400)
    parser.add_argument("--height", type=int, default=2400)
    args = parser.parse_args()

    download_elevation(tuple(args.bbox), Path(args.output), width=args.width, height=args.height)
